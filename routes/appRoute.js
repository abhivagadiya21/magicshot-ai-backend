...
router.post('/age-predictor', authMiddleware,
...
router.post('/age-journey', authMiddleware,
...
router.post('/baby-generator', authMiddleware,
...
router.post('/change-hairstyle', authMiddleware,
